...
export const DetectImages = ()=>{
    ...
    const input_name = ['iddetected_images','detected_imagescol','name']
   ...
   //get data
    useEffect(()=>{Axios.get(routs.image).then( (response: any)=>{setImages(response.data); console.log('images:',response.data)} );
    },[])
